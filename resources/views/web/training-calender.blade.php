...
@section('content')
    <section class="hero-section count-height" style="background-image: url('images/web/hero.png')">
        <div class="container">
            <div class="content">
                <h1 class="title">Training Calender</h1>

                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Training Calender</li>
                    </ol>
                </nav>
            </div>
    ...
    <section class="upcoming-calender">
        ...
        <div class="container">
            <div class="heading text-center mb-4">Upcoming Trainings</div>
...
{{---------------------- Past Events ------------------------------}}
    <section class="past-calender">
        ...
        <div class="container">
            <div class="heading text-center mb-4">Past Trainings</div>
