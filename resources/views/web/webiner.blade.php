...
@section('title')Webinar on ICT Tools |@endsection
...
@section('content')
    <section class="hero-section count-height" style="background-image: url('images/web/hero.png')">
        <div class="container">
            <div class="content">
                <h1 class="title">Webinar on ICT Tools</h1>

                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-0">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Webinar on ICT Tools</li>
                    </ol>
                </nav>
            </div>
    ...
    <section class="upcoming-webiner bg-light py-4 mb-4">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-10">
                    <h3 class="heading text-center mb-3 text-primary">Upcoming Webinars</h3>
                    ...
                    <div class="webinar-wrap">
                        <div class="row justify-content-center">
                            ...
                            <h4 class="text-center">No Webinar Found..</h4>
                            @endif
