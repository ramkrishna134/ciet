                ...
                <div class="card-body shadow">
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <input type="date" class="form-control" name="start_date" id="start_date" placeholder="Event Start Date">
                        </div>
                        <div class="col-6">
                            <label for="end_date" class="form-label">End Date</label>
                            <input type="date" class="form-control" name="end_date" id="end_date" placeholder="Event End Date">
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input id="thumbnail" class="form-control" type="text" name="filepath" value="{{ $event->featured_image ?? old('filepath') }}">
                    </div>
                    ...
                    <div id="holder2" style="margin-top:5px;width:100%;">
                     ...
                     <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control">{{ $event->event ?? old('description') }}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
